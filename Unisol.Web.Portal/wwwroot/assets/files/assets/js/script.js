...
$('#styleSelector').append('' +
    ...
    '<ul>' +
        '<li>' +
            '<a href="http://html.Abno.net/dash-able/bootstrap/default/builder.php" class="btn btn-danger btn-block m-t-10 waves-effect waves-light">Live Page Builder</a>' +
            '<div class="row">' +
                '<div class="col-6">' +
                    '<a href="https://themeforest.net/user/Abno" class="btn btn-success btn-block m-t-10 m-b-10 waves-effect waves-light">Profile</a>' +
                '</div>' +
                '<div class="col-6">' +
        ...
        '<li class="text-center">' +
            '<a href="https://www.facebook.com/Abno/" target="_blank" class="btn btn-facebook soc-icon m-b-20 waves-effect waves-light"><i class="feather icon-facebook"></i></a>' +
            '<a href="https://twitter.com/Abno" target="_blank" class="btn btn-twitter soc-icon m-l-20 m-b-20 waves-effect waves-light"><i class="feather icon-twitter"></i></a>' +
        '</li>' +
    '</ul>' +
    '');
