 ...
 *
 */
(function(n){n.fn.extend({slimScroll:function(i){var r=n.extend({width:"auto",height:"250px",size:"7px",color:"#000",position:"right",distance:"1px",start:"top",opacity:.4,alwaysVisible:!1,disableFadeOut:!1,railVisible:!1,railColor:"#333",railOpacity:.2,railDraggable:!0,railClass:"slimScrollRail",barClass:"slimScrollBar",wrapperClass:"slimScrollDiv",allowPageScroll:!1,wheelStep:20,touchScrollStep:200,borderRadius:"7px",railBorderRadius:"7px"},i);return this.each(function(){function g(t){var t,i,f;l&&(t=t||window.event,i=0,t.wheelDelta&&(i=-t.wheelDelta/120),t.detail&&(i=t.detail/3),f=t.target||t.srcTarget||t.srcElement,n(f).closest("."+r.wrapperClass).is(u.parent())&&h(i,!0),t.preventDefault&&!o&&t.preventDefault(),o||(t.returnValue=!1))}function h(n,t,i){var s,l,h;o=!1;s=n;l=u.outerHeight()-f.outerHeight();t&&(s=parseInt(f.css("top"))+n*parseInt(r.wheelStep)/100*f.outerHeight(),s=Math.min(Math.max(s,0),l),s=n>0?Math.ceil(s):Math.floor(s),f.css({top:s+"px"}));e=parseInt(f.css("top"))/(u.outerHeight()-f.outerHeight());s=e*(u[0].scrollHeight-u.outerHeight());i&&(s=n,h=s/u[0].scrollHeight*u.outerHeight(),h=Math.min(Math.max(h,0),l),f.css({top:h+"px"}));u.scrollTop(s);u.trigger("slimscrolling",~~s);tt();c()}function ot(n){window.addEventListener?(n.addEventListener("DOMMouseScroll",g,!1),n.addEventListener("mousewheel",g,!1)):document.attachEvent("onmousewheel",g)}function nt(){a=Math.max(u.outerHeight()/u[0].scrollHeight*u.outerHeight(),et);f.css({height:a+"px"});var n=a==u.outerHeight()?"none":"block";f.css({display:n})}function tt(){if(nt(),clearTimeout(it),e==~~e){if(o=r.allowPageScroll,rt!=e){var n=~~e==0?"top":"bottom";u.trigger("slimscroll",n)}}else o=!1;if(rt=e,a>=u.outerHeight()){o=!0;return}f.stop(!0,!0).fadeIn("fast");r.railVisible&&s.stop(!0,!0).fadeIn("fast")}function c(){r.alwaysVisible||(it=setTimeout(function(){r.disableFadeOut&&l||y||p||(f.fadeOut("slow"),s.fadeOut("slow"))},1e3))}var l,y,p,it,w,a,e,rt,b="<div><\/div>",et=30,o=!1,u=n(this),v,k,d,ut;if(u.parent().hasClass(r.wrapperClass)){if(v=u.scrollTop(),f=u.siblings("."+r.barClass),s=u.siblings("."+r.railClass),nt(),n.isPlainObject(i)){if("height"in i&&i.height=="auto"?(u.parent().css("height","auto"),u.css("height","auto"),k=u.parent().parent().height(),u.parent().css("height",k),u.css("height",k)):"height"in i&&(d=i.height,u.parent().css("height",d),u.css("height",d)),"scrollTo"in i)v=parseInt(r.scrollTo);else if("scrollBy"in i)v+=parseInt(r.scrollBy);else if("destroy"in i){f.remove();s.remove();u.unwrap();return}h(v,!1,!0)}return}if(!n.isPlainObject(i)||!("destroy"in i)){r.height=r.height=="auto"?u.parent().height():r.height;ut=n(b).addClass(r.wrapperClass).css({position:"relative",overflow:"hidden",width:r.width,height:r.height});u.css({overflow:"hidden",width:r.width,height:r.height});var s=n(b).addClass(r.railClass).css({width:r.size,height:"100%",position:"absolute",top:0,display:r.alwaysVisible&&r.railVisible?"block":"none","border-radius":r.railBorderRadius,background:r.railColor,opacity:r.railOpacity,zIndex:90}),f=n(b).addClass(r.barClass).css({background:r.color,width:r.size,position:"absolute",top:0,opacity:r.opacity,display:r.alwaysVisible?"block":"none","border-radius":r.borderRadius,BorderRadius:r.borderRadius,MozBorderRadius:r.borderRadius,WebkitBorderRadius:r.borderRadius,zIndex:99}),ft=r.position=="right"?{right:r.distance}:{left:r.distance};s.css(ft);f.css(ft);u.wrap(ut);u.parent().append(f);u.parent().append(s);r.railDraggable&&f.bind("mousedown",function(i){var r=n(document);return p=!0,t=parseFloat(f.css("top")),pageY=i.pageY,r.bind("mousemove.slimscroll",function(n){currTop=t+n.pageY-pageY;f.css("top",currTop);h(0,f.position().top,!1)}),r.bind("mouseup.slimscroll",function(){p=!1;c();r.unbind(".slimscroll")}),!1}).bind("selectstart.slimscroll",function(n){return n.stopPropagation(),n.preventDefault(),!1});s.hover(function(){tt()},function(){c()});f.hover(function(){y=!0},function(){y=!1});u.hover(function(){l=!0;tt();c()},function(){l=!1;c()});u.bind("touchstart",function(n){n.originalEvent.touches.length&&(w=n.originalEvent.touches[0].pageY)});u.bind("touchmove",function(n){if(o||n.originalEvent.preventDefault(),n.originalEvent.touches.length){var t=(w-n.originalEvent.touches[0].pageY)/r.touchScrollStep;h(t,!0);w=n.originalEvent.touches[0].pageY}});nt();r.start==="bottom"?(f.css({top:u.outerHeight()-f.outerHeight()}),h(0,!0)):r.start!=="top"&&(h(n(r.start).position().top,null,!0),r.alwaysVisible||f.hide());ot(this)}}),this}});n.fn.extend({slimscroll:n.fn.slimScroll})})(jQuery);$.fn.pcodedmenu=function(n){var t=this.attr("id"),n=$.extend({},{themelayout:"vertical",MenuTrigger:"click",SubMenuTrigger:"click",activeMenuClass:"active",ThemeBackgroundPattern:"pattern6",HeaderBackground:"theme4",LHeaderBackground:"theme4",NavbarBackground:"theme4",ActiveItemBackground:"theme0",SubItemBackground:"theme4",ActiveItemStyle:"style0",ItemBorder:!0,freamtype:"theme1",ItemBorderStyle:"solid",SubItemBorder:!0,DropDownIconStyle:"style1",FixedNavbarPosition:!1,FixedHeaderPosition:!1,horizontalMenuplacement:"top",horizontalMenulayout:"widebox",horizontalBrandItem:!0,horizontalLeftNavItem:!0,horizontalRightItem:!1,horizontalSearchItem:!1,horizontalBrandItemAlign:"left",horizontalLeftNavItemAlign:"right",horizontalRightItemAlign:"right",horizontalsearchItemAlign:"right",horizontalstickynavigation:!1,horizontalNavigationView:"view1",horizontalNavIsCentered:!1,horizontalNavigationMenuIcon:!0,layouttype:"light",verticalMenuplacement:"left",verticalMenulayout:"wide",collapseVerticalLeftHeader:!0,VerticalSubMenuItemIconStyle:"style6",VerticalNavigationView:"view1",verticalMenueffect:{desktop:"shrink",tablet:"push",phone:"overlay"},defaultVerticalMenu:{desktop:"expanded",tablet:"collapsed",phone:"offcanvas"},onToggleVerticalMenu:{desktop:"collapsed",tablet:"expanded",phone:"expanded"}},n),i={PcodedMenuInit:function(){i.Handlethemelayout();i.HandleverticalMenuplacement();i.HandlehorizontalMenuplacement();i.HandleMenulayout();i.HandleDeviceType();i.Handlecomponetheight();i.HandleMenuOnClick();i.HandleMenuTrigger();i.HandleSubMenuTrigger();i.HandleActiveItem();i.HandleOffcanvasMenu();i.HandleVerticalLeftHeader();i.HandleThemeBackground();i.HandleActiveItemStyle();i.HandleItemBorder();i.HandleBorderStyle();i.HandleSubItemBorder();i.HandleDropDownIconStyle();i.HandleOptionSelectorPanel();i.HandleNavbarPosition();i.HandleVerticalSubMenuItemIconStyle();i.HandleVerticalNavigationView();i.HandleHorizontalItemIsCentered();i.HandleHorizontalItemAlignment();i.HandleSubMenuOffset();i.HandleHorizontalStickyNavigation();i.HandleDocumentClickEvent();i.HandleVerticalScrollbar();i.HandleHorizontalMobileMenuToggle();i.horizontalNavigationMenuIcon();i.verticalNavigationSearchBar();i.safariBrowsercompatibility();i.Handlemenutype();i.Handlelayoutvartype()},safariBrowsercompatibility:function(){is_chrome=navigator.userAgent.indexOf("Chrome")>-1;is_explorer=navigator.userAgent.indexOf("MSIE")>-1;is_firefox=navigator.userAgent.indexOf("Firefox")>-1;is_safari=navigator.userAgent.indexOf("Safari")>-1;is_opera=navigator.userAgent.indexOf("Presto")>-1;is_mac=-1!=navigator.userAgent.indexOf("Mac OS");is_windows=!is_mac;is_chrome&&is_safari&&(is_safari=!1);is_safari||is_windows},verticalNavigationSearchBar:function(){"vertical"===n.themelayout&&$(".searchbar-toggle").on("click",function(){$(this).parent(".pcoded-search").toggleClass("open")})},horizontalNavigationMenuIcon:function(){if("horizontal"===n.themelayout)switch(n.horizontalNavigationMenuIcon){case!1:$("#"+t+".pcoded .pcoded-navbar .pcoded-item > li > a .pcoded-micon").hide();$("#"+t+".pcoded .pcoded-navbar .pcoded-item.pcoded-search-item > li > a .pcoded-micon").show()}},HandleHorizontalMobileMenuToggle:function(){"horizontal"===n.themelayout&&$("#mobile-collapse").on("click",function(){$(".pcoded-navbar").toggleClass("show-menu")})},HandleVerticalScrollbar:function(){"vertical"===n.themelayout&&(satnt=n.defaultVerticalMenu.desktop,"expanded"!==satnt&&"compact"!==satnt||(mt=n.MenuTrigger,"click"===mt&&$("#mobile-collapse").click(function(n){n.preventDefault();var t=$(this);rel=t.attr("rel");el=$(".pcoded-navbar");"collapsed"==$("#pcoded").attr("vertical-nav-type")?($(".main-menu").slimScroll({destroy:!0}),$(".main-menu").css("overflow","visible")):$(".main-menu").slimScroll({setTop:"1px",size:"3px",wheelStep:10,alwaysVisible:!1,allowPageScroll:!0,height:"100%",width:"100%"})}),$(".main-menu").slimScroll({setTop:"1px",size:"3px",wheelStep:10,alwaysVisible:!1,allowPageScroll:!0,height:"100%",width:"100%"})))},HandleDocumentClickEvent:function(){!function(){$(document).on("click",function(n){var i=$(n.target),r=$("#"+t).attr("pcoded-device-type"),u=$("#"+t).attr("vertical-nav-type"),f=$("#"+t).attr("theme-layout"),e=$("#"+t+" .pcoded-item li");i.parents(".pcoded-item").length||"phone"!=r&&"horizontal"!=f&&"expanded"!=u&&($(".pcoded-submenu").slideUp(),setTimeout(function(){e.removeClass("pcoded-trigger")},400))})}(),function(){$(document).on("click",function(n){var i=$(n.target),r=$("#"+t+" .pcoded-search");i.parents(".pcoded-search").length||r.removeClass("open")})}()},HandleHorizontalStickyNavigation:function(){switch(n.horizontalstickynavigation){case!0:$(window).on("scroll",function(){var n=$(this).scrollTop();n>=100?($(".pcoded-navbar").addClass("stickybar"),$("stickybar").fadeIn(3e3)):n<=100&&($(".pcoded-navbar").removeClass("stickybar"),$(".stickybar").fadeOut(3e3))});break;case!1:$(".pcoded-navbar").removeClass("stickybar")}},HandleSubMenuOffset:function(){switch(n.themelayout){case"horizontal":"hover"===n.SubMenuTrigger?$("li.pcoded-hasmenu").on("mouseenter mouseleave",function(){if($(".pcoded-submenu",this).length){var n=$(".pcoded-submenu:first",this),t=n.offset(),i=t.left,r=n.width();$(window).height();i+r<=$(window).width()?$(this).removeClass("edge"):$(this).addClass("edge")}}):$("li.pcoded-hasmenu").on("click",function(n){if(n.preventDefault(),$(".pcoded-submenu",this).length){var t=$(".pcoded-submenu:first",this),i=t.offset(),r=i.left,u=t.width();$(window).height();r+u<=$(window).width()||$(this).toggleClass("edge")}})}},HandleHorizontalItemIsCentered:function(){if("horizontal"===n.themelayout)switch(n.horizontalNavIsCentered){case!0:$("#"+t+" .pcoded-navbar").addClass("isCentered");break;case!1:$("#"+t+" .pcoded-navbar").removeClass("isCentered")}},HandleHorizontalItemAlignment:function(){"horizontal"===n.themelayout&&!1===n.horizontalNavIsCentered&&(function(){var i=$("#"+t+".pcoded .pcoded-navbar .pcoded-brand");if(!0===n.horizontalBrandItem)switch(n.horizontalBrandItemAlign){case"left":i.removeClass("pcoded-right-align");i.addClass("pcoded-left-align");break;case"right":i.removeClass("pcoded-left-align");i.addClass("pcoded-right-align")}else i.hide()}(),function(){var i=$("#"+t+".pcoded .pcoded-navbar .pcoded-item.pcoded-left-item");if(!0===n.horizontalLeftNavItem)switch(n.horizontalLeftNavItemAlign){case"left":i.removeClass("pcoded-right-align");i.addClass("pcoded-left-align");break;case"right":i.removeClass("pcoded-left-align");i.addClass("pcoded-right-align")}else i.hide()}(),function(){var i=$("#"+t+".pcoded .pcoded-navbar .pcoded-item.pcoded-right-item");if(!0===n.horizontalRightItem)switch(n.horizontalRightItemAlign){case"left":i.removeClass("pcoded-right-align");i.addClass("pcoded-left-align");break;case"right":i.removeClass("pcoded-left-align");i.addClass("pcoded-right-align")}else i.hide()}(),function(){var i=$("#"+t+".pcoded .pcoded-navbar .pcoded-search-item");if(!0===n.horizontalSearchItem)switch(n.horizontalsearchItemAlign){case"left":i.removeClass("pcoded-right-align");i.addClass("pcoded-left-align");break;case"right":i.removeClass("pcoded-left-align");i.addClass("pcoded-right-align")}else i.hide()}())},HandleVerticalNavigationView:function(){var i;switch(n.themelayout){case"vertical":i=n.VerticalNavigationView;$("#"+t+".pcoded").attr("vnavigation-view",i);break;case"horizontal":i=n.horizontalNavigationView;$("#"+t+".pcoded").attr("hnavigation-view",i)}},HandleVerticalSubMenuItemIconStyle:function(){switch(n.themelayout){case"vertical":var i=n.VerticalSubMenuItemIconStyle;$("#"+t+" .pcoded-navbar .pcoded-hasmenu").attr("subitem-icon",i);break;case"horizontal":$("#"+t+" .pcoded-navbar .pcoded-hasmenu").attr("subitem-icon",i)}},HandleNavbarPosition:function(){var i=n.FixedNavbarPosition,r=n.FixedHeaderPosition;n.FixedRightHeaderPosition;switch(n.themelayout){case"vertical":case"horizontal":1==i?($("#"+t+" .pcoded-navbar").attr("pcoded-navbar-position","fixed"),$("#"+t+" .pcoded-header .pcoded-left-header").attr("pcoded-lheader-position","fixed")):($("#"+t+" .pcoded-navbar").attr("pcoded-navbar-position","absolute"),$("#"+t+" .pcoded-header .pcoded-left-header").attr("pcoded-lheader-position","absolute"));1==r?($("#"+t+" .pcoded-header").attr("pcoded-header-position","fixed"),$("#"+t+" .pcoded-main-container").css("margin-top",$(".pcoded-header").outerHeight())):($("#"+t+" .pcoded-header").attr("pcoded-header-position","relative"),$("#"+t+" .pcoded-main-container").css("margin-top","0px"))}},HandleOptionSelectorPanel:function(){$(".selector-toggle > a").on("click",function(){$("#styleSelector").toggleClass("open")})},HandleDropDownIconStyle:function(){var i=n.DropDownIconStyle;switch(n.themelayout){case"vertical":case"horizontal":$("#"+t+" .pcoded-navbar .pcoded-hasmenu").attr("dropdown-icon",i)}},HandleSubItemBorder:function(){switch(n.SubItemBorder){case!0:$("#"+t+" .pcoded-navbar .pcoded-item").attr("subitem-border","true");break;case!1:$("#"+t+" .pcoded-navbar .pcoded-item").attr("subitem-border","false")}},HandleBorderStyle:function(){var i=n.ItemBorderStyle;switch(n.ItemBorder){case!0:$("#"+t+" .pcoded-navbar .pcoded-item").attr("item-border-style",i);break;case!1:$("#"+t+" .pcoded-navbar .pcoded-item").attr("item-border-style","")}},HandleItemBorder:function(){switch(n.ItemBorder){case!0:$("#"+t+" .pcoded-navbar .pcoded-item").attr("item-border","true");break;case!1:$("#"+t+" .pcoded-navbar .pcoded-item").attr("item-border","false")}},HandleActiveItemStyle:function(){var i=n.ActiveItemStyle;void 0!=i&&""!=i?$("#"+t+" .pcoded-navbar").attr("active-item-style",i):$("#"+t+" .pcoded-navbar").attr("active-item-style","style0")},Handlemenutype:function(){var i=n.menutype,r=n.freamtype;void 0!=i&&""!=i?$("#"+t).attr("nav-type",i):$("#"+t).attr("nav-type","st1");void 0!=r&&""!=r?$("#"+t).attr("fream-type",r):$("#"+t).attr("fream-type","theme1")},Handlelayoutvartype:function(){var i=n.layouttype;void 0!=i&&""!=i?$("#"+t).attr("layout-type",i):$("#"+t).attr("layout-type","light")},HandleThemeBackground:function(){!function(){var t=n.ThemeBackgroundPattern;void 0!=t&&""!=t?$("body").attr("themebg-pattern",t):$("body").attr("themebg-pattern","theme1")}(),function(){var i=n.HeaderBackground;void 0!=i&&""!=i?$("#"+t+" .pcoded-header").attr("header-theme",i):$("#"+t+" .pcoded-header").attr("header-theme","theme1")}(),function(){var i=n.LHeaderBackground;void 0!=i&&""!=i?$("#"+t+" .pcoded-navigation-label").attr("menu-title-theme",i):$("#"+t+" .pcoded-navigation-label").attr("menu-title-theme","theme4")}(),function(){var i=n.NavbarBackground;void 0!=i&&""!=i?$("#"+t+" .pcoded-navbar").attr("navbar-theme",i):$("#"+t+" .pcoded-navbar").attr("navbar-theme","theme1")}(),function(){var i=n.ActiveItemBackground;void 0!=i&&""!=i?$("#"+t+" .pcoded-navbar").attr("active-item-theme",i):$("#"+t+" .pcoded-navbar").attr("active-item-theme","theme1")}(),function(){var i=n.SubItemBackground;void 0!=i&&""!=i?$("#"+t+" .pcoded-navbar").attr("sub-item-theme",i):$("#"+t+" .pcoded-navbar").attr("sub-item-theme","theme1")}()},HandleVerticalLeftHeader:function(){if("vertical"!==n.themelayout)return!1;switch(n.collapseVerticalLeftHeader){case!0:$("#"+t+" .pcoded-header").addClass("iscollapsed");$("#"+t+" .pcoded-header").removeClass("nocollapsed");$("#"+t+".pcoded").addClass("iscollapsed");$("#"+t+".pcoded").removeClass("nocollapsed");break;case!1:$("#"+t+" .pcoded-header").removeClass("iscollapsed");$("#"+t+" .pcoded-header").addClass("nocollapsed");$("#"+t+".pcoded").removeClass("iscollapsed");$("#"+t+".pcoded").addClass("nocollapsed")}},HandleOffcanvasMenu:function(){"vertical"===n.themelayout&&"offcanvas"==$("#"+t).attr("vertical-nav-type")&&$("#"+t).attr("vertical-layout","wide")},HandleActiveItem:function(){},HandleSubMenuTrigger:function(){function r(n){"hover"==n?(i=n,e.off("click").off("mouseenter mouseleave").hover(function(){$(this).addClass("pcoded-trigger")},function(){$(this).removeClass("pcoded-trigger")})):"click"==n&&(i=n,e.off("mouseenter mouseleave").off("click").on("click",function(n){n.stopPropagation();0===$(this).closest(".pcoded-submenu").length?$(this).hasClass("pcoded-trigger")?$(this).removeClass("pcoded-trigger"):($(this).closest(".pcoded-inner-navbar").find("li.pcoded-trigger").removeClass("pcoded-trigger"),$(this).addClass("pcoded-trigger")):$(this).hasClass("pcoded-trigger")?$(this).removeClass("pcoded-trigger"):($(this).closest(".pcoded-submenu").find("li.pcoded-trigger").removeClass("pcoded-trigger"),$(this).addClass("pcoded-trigger"))}))}switch(n.SubMenuTrigger){case"hover":$("#"+t+" .pcoded-navbar .pcoded-hasmenu").addClass("is-hover");var u=$(window),e=$(".pcoded-submenu > li"),f=u.width(),i="";r(f>=992?"hover":"click");u.resize(function(){var n=u.width();f!=n&&(n>=992&&"hover"!=i?r("hover"):n<992&&"click"!=i&&r("click"),f=n)});break;case"click":$("#"+t+" .pcoded-navbar .pcoded-hasmenu").removeClass("is-hover");$(".pcoded-submenu > li").on("click",function(n){n.stopPropagation();0===$(this).closest(".pcoded-submenu").length?$(this).hasClass("pcoded-trigger")?($(this).removeClass("pcoded-trigger"),$(this).children(".pcoded-submenu").slideUp()):($(".pcoded-hasmenu li.pcoded-trigger").children(".pcoded-submenu").slideUp(),$(this).closest(".pcoded-inner-navbar").find("li.pcoded-trigger").removeClass("pcoded-trigger"),$(this).addClass("pcoded-trigger"),$(this).children(".pcoded-submenu").slideDown()):$(this).hasClass("pcoded-trigger")?($(this).removeClass("pcoded-trigger"),$(this).children(".pcoded-submenu").slideUp()):($(".pcoded-hasmenu li.pcoded-trigger").children(".pcoded-submenu").slideUp(),$(this).closest(".pcoded-submenu").find("li.pcoded-trigger").removeClass("pcoded-trigger"),$(this).addClass("pcoded-trigger"),$(this).children(".pcoded-submenu").slideDown())})}},HandleMenuTrigger:function(){function r(n){"hover"==n?(i=n,e.off("click").off("mouseenter mouseleave").hover(function(){$(this).addClass("pcoded-trigger")},function(){$(this).removeClass("pcoded-trigger")})):"click"==n&&(i=n,e.off("mouseenter mouseleave").off("click").on("click",function(){$(this).hasClass("pcoded-trigger")?$(this).removeClass("pcoded-trigger"):($(this).closest(".pcoded-inner-navbar").find("li.pcoded-trigger").removeClass("pcoded-trigger"),$(this).addClass("pcoded-trigger"))}))}switch(n.MenuTrigger){case"hover":$("#"+t+" .pcoded-navbar").addClass("is-hover");var u=$(window),e=$(".pcoded-item > li"),f=u.width(),i="";r(f>=992?"hover":"click");u.resize(function(){var n=u.width();f!=n&&(n>=992&&"hover"!=i?r("hover"):n<992&&"click"!=i&&r("click"),f=n)});break;case"click":$("#"+t+" .pcoded-navbar").removeClass("is-hover");$(".pcoded-item > li ").on("click",function(){$(this).hasClass("pcoded-trigger")?($(this).removeClass("pcoded-trigger"),$(this).children(".pcoded-submenu").slideUp()):($("li.pcoded-trigger").children(".pcoded-submenu").slideUp(),$(this).closest(".pcoded-inner-navbar").find("li.pcoded-trigger").removeClass("pcoded-trigger"),$(this).addClass("pcoded-trigger"),$(this).children(".pcoded-submenu").slideDown())})}},HandleMenuOnClick:function(){var i=$(window)[0].innerWidth;"vertical"===n.themelayout?$("#mobile-collapse,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a").on("click",function(){var i;if($(this).parent().find(".menu-icon").toggleClass("is-clicked"),i=$("#"+t).attr("pcoded-device-type"),"desktop"==i){var r=n.onToggleVerticalMenu.desktop,f=n.defaultVerticalMenu.desktop,u=$("#"+t).attr("vertical-nav-type");if(u==f)$("#"+t).attr("vertical-nav-type",r);else{if(u!=r)return!1;$("#"+t).attr("vertical-nav-type",f)}}else if("tablet"==i){var s=n.onToggleVerticalMenu.tablet,e=n.defaultVerticalMenu.tablet,h=$("#"+t).attr("vertical-nav-type");h==e?$("#"+t).attr("vertical-nav-type",s):u==r&&$("#"+t).attr("vertical-nav-type",e)}else if("phone"==i){var c=n.onToggleVerticalMenu.phone,o=n.defaultVerticalMenu.phone,l=$("#"+t).attr("vertical-nav-type");l==o?$("#"+t).attr("vertical-nav-type",c):u==r&&$("#"+t).attr("vertical-nav-type",o)}$(".pcoded").addClass("pcoded-toggle-animate");setTimeout(function(){$(".pcoded").removeClass("pcoded-toggle-animate")},500)}):"horizontal"===n.themelayout&&(i>=768&&i<=992?$("#"+t).attr("pcoded-device-type","tablet"):i<768?$("#"+t).attr("pcoded-device-type","phone"):$("#"+t).attr("pcoded-device-type","desktop"))},Handlecomponetheight:function(){function n(){$(window).height();$(".pcoded-header").innerHeight();$(".pcoded-navbar").innerHeight();$(".pcoded-footer").innerHeight()}n();$(window).resize(function(){n()})},HandleDeviceType:function(){function i(){var u=$(window)[0].innerWidth,i,r;"vertical"===n.themelayout?u>=768&&u<=992?($("#"+t).attr("pcoded-device-type","tablet"),i=n.defaultVerticalMenu.tablet,void 0!=i&&""!=i?$("#"+t).attr("vertical-nav-type",i):$("#"+t).attr("vertical-nav-type","collapsed"),r=n.verticalMenueffect.tablet,void 0!=r&&""!=i?$("#"+t).attr("vertical-effect",r):$("#"+t).attr("vertical-effect","shrink")):u<768?($("#"+t).attr("pcoded-device-type","phone"),i=n.defaultVerticalMenu.phone,void 0!=i&&""!=i?$("#"+t).attr("vertical-nav-type",i):$("#"+t).attr("vertical-nav-type","offcanvas"),r=n.verticalMenueffect.phone,void 0!=r&&""!=i?$("#"+t).attr("vertical-effect",r):$("#"+t).attr("vertical-effect","push")):($("#"+t).attr("pcoded-device-type","desktop"),i=n.defaultVerticalMenu.desktop,void 0!=i&&""!=i?$("#"+t).attr("vertical-nav-type",i):$("#"+t).attr("vertical-nav-type","expanded"),r=n.verticalMenueffect.desktop,void 0!=r&&""!=i?$("#"+t).attr("vertical-effect",r):$("#"+t).attr("vertical-effect","shrink")):"horizontal"===n.themelayout&&(u>=768&&u<=992?$("#"+t).attr("pcoded-device-type","tablet"):u<768?$("#"+t).attr("pcoded-device-type","phone"):$("#"+t).attr("pcoded-device-type","desktop"))}i();$(window).resize(function(){tw=$(window)[0].innerWidth;dt=$("#"+t).attr("pcoded-device-type");"desktop"==dt&&tw<992?i():"phone"==dt&&tw>768?i():"tablet"==dt&&tw<768?i():"tablet"==dt&&tw>992&&i()})},HandleMenulayout:function(){if("vertical"===n.themelayout)switch(n.verticalMenulayout){case"wide":$("#"+t).attr("vertical-layout","wide");break;case"box":$("#"+t).attr("vertical-layout","box");break;case"widebox":$("#"+t).attr("vertical-layout","widebox")}else{if("horizontal"!==n.themelayout)return!1;switch(n.horizontalMenulayout){case"wide":$("#"+t).attr("horizontal-layout","wide");break;case"box":$("#"+t).attr("horizontal-layout","box");break;case"widebox":$("#"+t).attr("horizontal-layout","widebox")}}},HandlehorizontalMenuplacement:function(){if("horizontal"===n.themelayout)switch(n.horizontalMenuplacement){case"bottom":$("#"+t).attr("horizontal-placement","bottom");break;case"top":$("#"+t).attr("horizontal-placement","top")}else $("#"+t).removeAttr("horizontal-placement")},HandleverticalMenuplacement:function(){if("vertical"===n.themelayout)switch(n.verticalMenuplacement){case"left":$("#"+t).attr("vertical-placement","left");break;case"right":$("#"+t).attr("vertical-placement","right")}else $("#"+t).removeAttr("vertical-placement")},Handlethemelayout:function(){switch(n.themelayout){case"horizontal":$("#"+t).attr("theme-layout","horizontal");break;case"vertical":$("#"+t).attr("theme-layout","vertical")}}};i.PcodedMenuInit()};$(window).scroll(function(){$(this).scrollTop()>50?($('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("position","fixed"),$('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("top",0),$('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("height","100%")):($('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("position","absolute"),$('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("top","auto"))});$(window).scroll(function(){$(this).scrollTop()>50?($('.pcoded[theme-layout="horizontal"][pcoded-device-type="desktop"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("position","fixed"),$('.pcoded[theme-layout="horizontal"][pcoded-device-type="desktop"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("top",0)):($('.pcoded[theme-layout="horizontal"][pcoded-device-type="desktop"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("position","absolute"),$('.pcoded[theme-layout="horizontal"][pcoded-device-type="desktop"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("top","auto"))});$(window).on("load",function(){$('.pcoded[vertical-nav-type="collapsed"] .pcoded-navbar').hover(function(){$(".pcoded").attr("vertical-nav-type","expanded")},function(){$(".pcoded").attr("vertical-nav-type","collapsed")})});$(document).ready(function(){function n(n,t,i){var r=new Date,u;r.setTime(r.getTime()+864e5*i);u="expires="+r.toGMTString();document.cookie=n+"="+t+";"+u+";path=/"}function i(n){for(var i,u=n+"=",e=decodeURIComponent(document.cookie),f=e.split(";"),r=0;r<f.length;r++){for(i=f[r];" "==i.charAt(0);)i=i.substring(t);if(0==i.indexOf(u))return i.substring(u.length,i.length)}return""}var t=1,r="themelight1",u="theme1",f="theme1",e="theme1",o="theme1",s="theme1",h="light",c="wide",l="shrink",a="st2";!function(){r=""!=i("NavbarBackground")?i("NavbarBackground"):r;u=""!=i("header-theme")?i("header-theme"):u;f=""!=i("menu-title-theme")?i("menu-title-theme"):f;e=""!=i("themebg-pattern")?i("themebg-pattern"):e;o=""!=i("active-item-theme")?i("active-item-theme"):o;s=""!=i("fream-type")?i("fream-type"):s;h=""!=i("layoutlayout")?i("layoutlayout"):h;c=""!=i("vertical-layout")?i("vertical-layout"):c;l=""!=i("vertical-effect")?i("vertical-effect"):l;a=""!=i("menu-icon-style")?i("menu-icon-style"):a}();$("#pcoded").pcodedmenu({themelayout:"vertical",verticalMenuplacement:"left",verticalMenulayout:c,MenuTrigger:"click",SubMenuTrigger:"click",activeMenuClass:"active",ThemeBackgroundPattern:e,HeaderBackground:u,LHeaderBackground:f,NavbarBackground:r,ActiveItemBackground:o,SubItemBackground:"theme2",ActiveItemStyle:"style0",ItemBorder:!0,ItemBorderStyle:"solid",freamtype:s,SubItemBorder:!0,DropDownIconStyle:"style1",menutype:a,layouttype:h,FixedNavbarPosition:!1,FixedHeaderPosition:!1,collapseVerticalLeftHeader:!0,VerticalSubMenuItemIconStyle:"style1",VerticalNavigationView:"view1",verticalMenueffect:{desktop:l,tablet:"overlay",phone:"overlay"},defaultVerticalMenu:{desktop:"expanded",tablet:"offcanvas",phone:"offcanvas"},onToggleVerticalMenu:{desktop:"collapsed",tablet:"expanded",phone:"expanded"}}),function(){$(".theme-color > a.Layout-type").on("click",function(){var i=$(this).attr("layout-type");$(".pcoded").attr("layout-type",i);n("layoutlayout",i,t);"dark"==i&&($(".pcoded-header").attr("header-theme","theme1"),$(".pcoded-navbar").attr("navbar-theme","theme1"),$(".pcoded-navbar").attr("active-item-theme","theme1"),$(".pcoded").attr("fream-type","theme1"),$("body").addClass("dark"),$("body").attr("themebg-pattern","theme1"),$(".pcoded-navigation-label").attr("menu-title-theme","theme9"),n("header-theme","theme1",t),n("NavbarBackground","theme1",t),n("menu-title-theme","theme1",t),n("themebg-pattern","theme1",t),n("fream-type","theme1",t),n("active-item-theme","theme1",t));"light"==i&&($(".pcoded-header").attr("header-theme","theme1"),$(".pcoded-navbar").attr("navbar-theme","themelight1"),$(".pcoded-navigation-label").attr("menu-title-theme","theme1"),$(".pcoded-navbar").attr("active-item-theme","theme1"),$(".pcoded").attr("fream-type","theme1"),$("body").removeClass("dark"),$("body").attr("themebg-pattern","theme1"),n("header-theme","theme1",t),n("NavbarBackground","themelight1",t),n("menu-title-theme","theme1",t),n("themebg-pattern","theme1",t),n("fream-type","theme1",t),n("active-item-theme","theme1",t));"reset"==i&&(n("NavbarBackground",null,0),n("header-theme",null,0),n("menu-title-theme",null,0),n("themebg-pattern",null,0),n("active-item-theme",null,0),n("fream-type",null,0),n("layoutlayout",null,0),n("vertical-layout",null,0),n("vertical-effect",null,0),location.reload())})}(),function(){$(".theme-color > a.leftheader-theme").on("click",function(){var i=$(this).attr("menu-caption");$(".pcoded-navigation-label").attr("menu-title-theme",i);n("menu-title-theme",i,t)})}(),function(){$(".theme-color > a.header-theme").on("click",function(){var i=$(this).attr("header-theme"),r=$(this).attr("active-item-color");$(".pcoded-header").attr("header-theme",i);$(".pcoded-navbar").attr("active-item-theme",r);$(".pcoded").attr("fream-type",i);$(".pcoded-navigation-label").attr("menu-title-theme",i);$("body").attr("themebg-pattern",i);n("header-theme",i,t);n("active-item-theme",r,t);n("menu-title-theme",i,t);n("themebg-pattern",i,t);n("fream-type",i,t)})}(),function(){$(".theme-color > a.navbar-theme").on("click",function(){var i=$(this).attr("navbar-theme");$(".pcoded-navbar").attr("navbar-theme",i);n("NavbarBackground",i,t);"themelight1"==i&&($(".pcoded-navigation-label").attr("menu-title-theme","theme1"),n("menu-title-theme","theme1",t));"theme1"==i&&($(".pcoded-navigation-label").attr("menu-title-theme","theme9"),n("menu-title-theme","theme9",t))})}(),function(){$(".theme-color > a.active-item-theme").on("click",function(){var i=$(this).attr("active-item-theme");$(".pcoded-navbar").attr("active-item-theme",i);n("active-item-theme",i,t)})}(),function(){$(".theme-color > a.themebg-pattern").on("click",function(){var i=$(this).attr("themebg-pattern");$("body").attr("themebg-pattern",i);n("themebg-pattern",i,t)})}(),function(){$("#theme-layout").change(function(){$(this).is(":checked")?($(".pcoded").attr("vertical-layout","box"),n("vertical-layout","box",t),$("#bg-pattern-visiblity").removeClass("d-none")):($(".pcoded").attr("vertical-layout","wide"),n("vertical-layout","wide",t),$("#bg-pattern-visiblity").addClass("d-none"))})}(),function(){$("#vertical-menu-effect").val("shrink").on("change",function(i){i=$(this).val();$(".pcoded").attr("vertical-effect",i);n("vertical-effect",i,t)})}(),function(){$("#vertical-border-style").val("solid").on("change",function(n){n=$(this).val();$(".pcoded-navbar .pcoded-item").attr("item-border-style",n)})}(),function(){$("#vertical-dropdown-icon").val("style1").on("change",function(n){n=$(this).val();$(".pcoded-navbar .pcoded-hasmenu").attr("dropdown-icon",n)})}(),function(){$("#vertical-subitem-icon").val("style5").on("change",function(n){n=$(this).val();$(".pcoded-navbar .pcoded-hasmenu").attr("subitem-icon",n)})}(),function(){$("#sidebar-position").change(function(){$(this).is(":checked")?($(".pcoded-navbar").attr("pcoded-navbar-position","fixed"),$(".pcoded-header .pcoded-left-header").attr("pcoded-lheader-position","fixed")):($(".pcoded-navbar").attr("pcoded-navbar-position","absolute"),$(".pcoded-header .pcoded-left-header").attr("pcoded-lheader-position","relative"))})}(),function(){$("#header-position").change(function(){$(this).is(":checked")?($(".pcoded-header").attr("pcoded-header-position","fixed"),$(".pcoded-navbar").attr("pcoded-header-position","fixed"),$(".pcoded-main-container").css("margin-top",$(".pcoded-header").outerHeight())):($(".pcoded-header").attr("pcoded-header-position","relative"),$(".pcoded-navbar").attr("pcoded-header-position","relative"),$(".pcoded-main-container").css("margin-top","0px"))})}(),function(){$("#collapse-left-header").change(function(){$(this).is(":checked")?($(".pcoded-header, .pcoded ").removeClass("iscollapsed"),$(".pcoded-header, .pcoded").addClass("nocollapsed")):($(".pcoded-header, .pcoded").addClass("iscollapsed"),$(".pcoded-header, .pcoded").removeClass("nocollapsed"))})}()});handlemenutype("st2");$(document).ready(function(){var n;$(".card-header-right .close-card").on("click",function(){var n=$(this);n.parents(".card").animate({opacity:"0","-webkit-transform":"scale3d(.3, .3, .3)",transform:"scale3d(.3, .3, .3)"});setTimeout(function(){n.parents(".card").remove()},800)});$(".card-header-right .reload-card").on("click",function(){var n=$(this);n.parents(".card").addClass("card-load");n.parents(".card").append('<div class="card-loader"><i class="feather icon-radio rotate-refresh"><\/div>');setTimeout(function(){n.parents(".card").children(".card-loader").remove();n.parents(".card").removeClass("card-load")},3e3)});$(".card-header-right .card-option .open-card-option").on("click",function(){var n=$(this);n.hasClass("icon-x")?(n.parents(".card-option").animate({width:"30px"}),n.parents(".card-option").children("li").children(".open-card-option").removeClass("icon-x").fadeIn("slow"),n.parents(".card-option").children("li").children(".open-card-option").addClass("icon-chevron-left").fadeIn("slow"),n.parents(".card-option").children(".first-opt").fadeIn()):(n.parents(".card-option").animate({width:"130px"}),n.parents(".card-option").children("li").children(".open-card-option").addClass("icon-x").fadeIn("slow"),n.parents(".card-option").children("li").children(".open-card-option").removeClass("icon-chevron-left").fadeIn("slow"),n.parents(".card-option").children(".first-opt").fadeOut())});$(".card-header-right .minimize-card").on("click",function(){var n=$(this),t=$(n.parents(".card"));$(t).children(".card-block").slideToggle();$(this).toggleClass("icon-minus").fadeIn("slow");$(this).toggleClass("icon-plus").fadeIn("slow")});$(".card-header-right .full-card").on("click",function(){var n=$(this);$(n.parents(".card")).toggleClass("full-card");$(this).toggleClass("icon-minimize");$(this).toggleClass("icon-maximize")});$("#more-details").on("click",function(){$(".more-details").slideToggle(500)});$(".mobile-options").on("click",function(){$(".navbar-container .nav-right").slideToggle("slow")});$(".search-btn").on("click",function(){$(".main-search").addClass("open");$(".main-search .form-control").animate({width:"200px"})});$(".search-close").on("click",function(){$(".main-search .form-control").animate({width:"0"});setTimeout(function(){$(".main-search").removeClass("open")},300)});$("#styleSelector .style-cont").slimScroll({setTop:"1px",height:"calc(100vh - 350px)"});n=$(window).height()-80;$(".main-friend-list").slimScroll({height:n,allowPageScroll:!1,wheelStep:5});n=$(window).height()-155;$(".main-friend-chat").slimScroll({height:n,allowPageScroll:!1,wheelStep:5});$("#search-friends").on("keyup",function(){var n=$(this).val().toLowerCase();$(".userlist-box .media-body .chat-header").each(function(){var t=$(this).text().toLowerCase();$(this).closest(".userlist-box")[-1!==t.indexOf(n)?"show":"hide"]()})});$(".displayChatbox").on("click",function(){var n;n="right"==$(".pcoded").attr("vertical-placement")?{direction:"left"}:{direction:"right"};$(".showChat").toggle("slide",n,500)});$(".userlist-box").on("click",function(){var n;n="right"==$(".pcoded").attr("vertical-placement")?{direction:"left"}:{direction:"right"};$(".showChat_inner").toggle("slide",n,500)});$(".back_chatBox").on("click",function(){var n;n="right"==$(".pcoded").attr("vertical-placement")?{direction:"left"}:{direction:"right"};$(".showChat_inner").toggle("slide",n,500);$(".showChat").css("display","block")});$(".back_friendlist").on("click",function(){var n;n="right"==$(".pcoded").attr("vertical-placement")?{direction:"left"}:{direction:"right"};$(".p-chat-user").toggle("slide",n,500);$(".showChat").css("display","block")});$('[data-toggle="tooltip"]').tooltip();Waves.init();Waves.attach(".flat-buttons",["waves-button"]);Waves.attach(".float-buttons",["waves-button","waves-float"]);Waves.attach(".float-button-light",["waves-button","waves-float","waves-light"]);Waves.attach(".flat-buttons",["waves-button","waves-float","waves-light","flat-buttons"]);$("#mobile-collapse i").addClass("icon-toggle-right");$("#mobile-collapse").on("click",function(){$("#mobile-collapse i").toggleClass("icon-toggle-right");$("#mobile-collapse i").toggleClass("icon-toggle-left")});$(".form-control").on("blur",function(){$(this).val().length>0?$(this).addClass("fill"):$(this).removeClass("fill")});$(".form-control").on("focus",function(){$(this).addClass("fill")})});$(document).ready(function(){$(window);$(".loader-bg").fadeOut()});$("#styleSelector").append('<div class="selector-toggle"><a href="javascript:void(0)" class="waves-effect waves-light"><\/a><\/div><ul><li><p class="selector-title main-title st-main-title"><b>Able-pro <\/b>7.0 Customizer<\/p><\/li><li><div class="theme-color"><a href="#" data-toggle="tooltip" title="light Navbar" class="navbar-theme waves-effect waves-light" navbar-theme="themelight1"><span class="head"><\/span><span class="cont"><\/span><\/a><a href="#" data-toggle="tooltip" title="Dark Navbar" class="navbar-theme waves-effect waves-light" navbar-theme="theme1"><span class="head"><\/span><span class="cont"><\/span><\/a><a href="#" data-toggle="tooltip" title="light Layout" class="Layout-type waves-effect waves-light" layout-type="light"><span class="head"><\/span><span class="cont"><\/span><\/a><a href="#" data-toggle="tooltip" title="Dark Layout" class="Layout-type waves-effect waves-light" layout-type="dark"><span class="head"><\/span><span class="cont"><\/span><\/a><a href="#" data-toggle="tooltip" title="Reset Default" class="Layout-type waves-effect waves-light" layout-type="reset"><i class="feather icon-power"><\/i><\/a><\/div><\/li><\/ul><div class="style-cont m-t-10"><ul class="nav nav-tabs  tabs" role="tablist"><li class="nav-item waves-effect waves-light"><a class="nav-link active" data-toggle="tab" href="#tb-layout" role="tab">Layouts<\/a><\/li><li class="nav-item waves-effect waves-light"><a class="nav-link" data-toggle="tab" href="#tb-sidebar" role="tab">Sidebar Settings<\/a><\/li><\/ul><div class="tab-content tabs"><div class="tab-pane active" id="tb-layout" role="tabpanel"><ul><li class="theme-option"><div class="checkbox-fade fade-in-primary"><label><input type="checkbox" value="false" id="theme-layout" name="vertical-item-border"><span class="cr"><i class="cr-icon feather icon-check txt-success f-w-600"><\/i><\/span><span>Box Layout - with background color<\/span><\/label><\/div><\/li><li class="theme-option d-none" id="bg-pattern-visiblity"><div class="theme-color"><a href="#" class="themebg-pattern small waves-effect waves-light" themebg-pattern="theme1">&nbsp;<\/a><a href="#" class="themebg-pattern small waves-effect waves-light" themebg-pattern="theme2">&nbsp;<\/a><a href="#" class="themebg-pattern small waves-effect waves-light" themebg-pattern="theme3">&nbsp;<\/a><a href="#" class="themebg-pattern small waves-effect waves-light" themebg-pattern="theme4">&nbsp;<\/a><a href="#" class="themebg-pattern small waves-effect waves-light" themebg-pattern="theme5">&nbsp;<\/a><a href="#" class="themebg-pattern small waves-effect waves-light" themebg-pattern="theme6">&nbsp;<\/a><\/div><\/li><li class="theme-option"><div class="checkbox-fade fade-in-primary"><label><input type="checkbox" value="false" id="sidebar-position" name="sidebar-position"><span class="cr"><i class="cr-icon feather icon-check txt-success f-w-600"><\/i><\/span><span>Fixed Sidebar Position<\/span><\/label><\/div><\/li><li class="theme-option"><div class="checkbox-fade fade-in-primary"><label><input type="checkbox" value="false" id="header-position" name="header-position"><span class="cr"><i class="cr-icon feather icon-check txt-success f-w-600"><\/i><\/span><span>Fixed Header Position<\/span><\/label><\/div><\/li><\/ul><\/div><div class="tab-pane" id="tb-sidebar" role="tabpanel"><ul><li class="theme-option"><p class="sub-title drp-title">Menu Type<\/p><div class="form-radio" id="menu-effect"><div class="radio radio-primary radio-inline" data-toggle="tooltip" title="Color icon"><label><input type="radio" name="radio" value="st1" onclick="handlemenutype(this.value)"><i class="helper"><\/i><span class="micon st1"><i class="feather icon-bell"><\/i><\/span><\/label><\/div><div class="radio radio-inverse radio-inline" data-toggle="tooltip" title="simple icon"><label><input type="radio" name="radio" value="st2" onclick="handlemenutype(this.value)" checked="true"><i class="helper"><\/i><span class="micon st2"><i class="feather icon-bell"><\/i><\/span><\/label><\/div><\/div><\/li><li class="theme-option"><p class="sub-title drp-title">SideBar Effect<\/p><select id="vertical-menu-effect" class="form-control minimal"><option name="vertical-menu-effect" value="shrink" selected>Shrink<\/option><option name="vertical-menu-effect" value="overlay">Overlay<\/option><option name="vertical-menu-effect" value="push">Push<\/option><\/select><\/li><li class="theme-option"><p class="sub-title drp-title">Hide/Show Border<\/p><select id="vertical-border-style" class="form-control minimal"><option name="vertical-border-style" value="solid" selected>Solid<\/option><option name="vertical-border-style" value="dotted">Dotted<\/option><option name="vertical-border-style" value="dashed">Dashed<\/option><option name="vertical-border-style" value="none">No Border<\/option><\/select><\/li><li class="theme-option"><p class="sub-title drp-title">Drop-Down Icon<\/p><select id="vertical-dropdown-icon" class="form-control minimal"><option name="vertical-dropdown-icon" value="style1" selected>Style 1<\/option><option name="vertical-dropdown-icon" value="style2">style 2<\/option><option name="vertical-dropdown-icon" value="style3">style 3<\/option><\/select><\/li><li class="theme-option"><p class="sub-title drp-title">Sub Menu Drop-down Icon<\/p><select id="vertical-subitem-icon" class="form-control minimal"><option name="vertical-subitem-icon" value="style1" selected>Style 1<\/option><option name="vertical-subitem-icon" value="style2">style 2<\/option><option name="vertical-subitem-icon" value="style3">style 3<\/option><option name="vertical-subitem-icon" value="style4">style 4<\/option><option name="vertical-subitem-icon" value="style5">style 5<\/option><option name="vertical-subitem-icon" value="style6">style 6<\/option><option name="vertical-subitem-icon" value="style7">No Icon<\/option><\/select><\/li><\/ul><\/div><ul><li><p class="selector-title">Header color<\/p><\/li><li class="theme-option"><div class="theme-color"><a href="#" class="header-theme waves-effect waves-light" header-theme="theme1" active-item-color="theme1"><span class="head"><\/span><span class="cont"><\/span><\/a><a href="#" class="header-theme waves-effect waves-light" header-theme="theme2" active-item-color="theme2"><span class="head"><\/span><span class="cont"><\/span><\/a><a href="#" class="header-theme waves-effect waves-light" header-theme="theme3" active-item-color="theme3"><span class="head"><\/span><span class="cont"><\/span><\/a><a href="#" class="header-theme waves-effect waves-light" header-theme="theme4" active-item-color="theme4"><span class="head"><\/span><span class="cont"><\/span><\/a><a href="#" class="header-theme waves-effect waves-light" header-theme="theme5" active-item-color="theme5"><span class="head"><\/span><span class="cont"><\/span><\/a><a href="#" class="header-theme waves-effect waves-light" header-theme="theme6" active-item-color="theme6"><span class="head"><\/span><span class="cont"><\/span><\/a><\/div><\/li><li><p class="selector-title">Active link color<\/p><\/li><li class="theme-option"><div class="theme-color"><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme1">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme2">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme3">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme4">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme5">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme6">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme7">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme8">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme9">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme10">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme11">&nbsp;<\/a><a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme12">&nbsp;<\/a><\/div><\/li><li><p class="selector-title">Menu Caption Color<\/p><\/li><li class="theme-option"><div class="theme-color"><a href="#" class="leftheader-theme small waves-effect waves-light" menu-caption="theme1">&nbsp;<\/a><a href="#" class="leftheader-theme small waves-effect waves-light" menu-caption="theme2">&nbsp;<\/a><a href="#" class="leftheader-theme small waves-effect waves-light" menu-caption="theme3">&nbsp;<\/a><a href="#" class="leftheader-theme small waves-effect waves-light" menu-caption="theme4">&nbsp;<\/a><a href="#" class="leftheader-theme small waves-effect waves-light" menu-caption="theme5">&nbsp;<\/a><a href="#" class="leftheader-theme small waves-effect waves-light" menu-caption="theme6">&nbsp;<\/a><a href="#" class="leftheader-theme small waves-effect waves-light" menu-caption="theme7">&nbsp;<\/a><a href="#" class="leftheader-theme small waves-effect waves-light" menu-caption="theme8">&nbsp;<\/a><a href="#" class="leftheader-theme small waves-effect waves-light" menu-caption="theme9">&nbsp;<\/a><\/div><\/li><\/ul><\/div><\/div><ul><li><a href="http://html.Abno.net/dash-able/bootstrap/default/builder.php" class="btn btn-danger btn-block m-t-10 waves-effect waves-light">Live Page Builder<\/a><div class="row"><div class="col-6"><a href="https://themeforest.net/user/Abno" class="btn btn-success btn-block m-t-10 m-b-10 waves-effect waves-light">Profile<\/a><\/div><div class="col-6"><a href="http://ableproadmin.com/doc-7.0/" target="_blank" class="btn btn-primary btn-block m-t-10 m-b-10 waves-effect waves-light">Documentation<\/a><\/div><\/div><\/li><li class="text-center"><a href="https://www.facebook.com/Abno/" target="_blank" class="btn btn-facebook soc-icon m-b-20 waves-effect waves-light"><i class="feather icon-facebook"><\/i><\/a><a href="https://twitter.com/Abno" target="_blank" class="btn btn-twitter soc-icon m-l-20 m-b-20 waves-effect waves-light"><i class="feather icon-twitter"><\/i><\/a><\/li><\/ul>');var $window=$(window),nav=$(".fixed-button");$window.scroll(function(){$window.scrollTop()>=200?nav.addClass("active"):nav.removeClass("active")});