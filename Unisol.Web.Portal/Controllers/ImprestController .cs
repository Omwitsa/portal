...
namespace Unisol.Web.Portal.Controllers
{
    ...
    public class ImprestController : Controller
    {
        ...
        public ImprestController(IUnisolApiProxy unisolApiProxy, PortalCoreContext context)
        {
        ...
        public JsonResult GetImprest(string userCode, string searchString)
        {
            ...
            var createResults = _unisolApiProxy.GetEmployeeImprest(userCode, searchString).Result;
            var jdata = JsonConvert.DeserializeObject<ReturnData<dynamic>>(createResults);
            return Json(jdata);
        }
        
        [HttpPost("SaveImprest")]
