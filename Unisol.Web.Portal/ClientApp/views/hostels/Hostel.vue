      ...
      <div class="col-lg-12">
        <div class="tab-header card">
          <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist">
            <li class="nav-item">
              <router-link exact-active-class="active" class="nav-link" to="/hostel/book-hostel">
                Book
            ...
            <li class="nav-item">
              <router-link
                ...
                class="nav-link"
                to="/hostel/hostel-list"
              >History</router-link>
              <div class="slide"></div>
            </li>
          </ul>
        </div>
        <div class="tab-content" v-show="allowedOnlineBooking">
          <router-view></router-view>
        </div>
        <div class="tab-content page-body" v-if="!checkingBookingHttp">
          <div class="card">
