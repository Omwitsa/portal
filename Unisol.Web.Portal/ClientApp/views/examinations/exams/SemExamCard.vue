                ...
                <div class="row">
                    <div class="col-md-5" style="font-size:12px">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                {{institutionInfo.orgName}} <br>
                                {{institutionInfo.box}} <br>
                                {{institutionInfo.tel}}<br>
                                {{institutionInfo.email}}<br>
                            </div>
                        </div>
    ...
    export default {
        data() {
            return {
                ...
                eligibleMessage: '',
                title: "Current Exam Card",
                subTitle: "Show exam card for current semester",
