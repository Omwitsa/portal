                ...
                <div class="card-header">
                 ...
                 <div class="card-block">
                     <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <h4 class="eventTitle">{{this.event.eventTitle}}<hr></h4>
                            <div class="row">
                                <div class="col-md-4"><h6>{{"From Date: "+ startDate}}</h6></div>
                                <div class="col-md-4"><h6>{{"- To Date: "+endDate}}</h6></div>
                            </div><hr>
                            <p v-html="event.eventDesc"></p><br>
                            Date Created: <div class="m-r-30 badge badge-primary">{{ EventsDateCreated }}</div>
                        </div>
                     </div>
                 </div>
            </div>
        ...
        getEventDetails(id) {
            ...
            .then(response => {
                if (response.data.success) {
                    ...
                    this.EventsDateCreated = DateFomatter.ReturnDate(this.event.dateCreated)
