                            ...
                            <section>
                                ...
                                <div class="actions clearfix">
                                    <ul role="menu" aria-label="Pagination">
                                        ...
                                        <li v-if="step<2" class="btn btn-inverse btn-round waves-effect waves-light " @click="next()">Next</li> 

                                        <li v-if="step==2">
                                            <a class="btn btn-inverse btn-round waves-effect waves-light " @click="save()">Finish</a>
                                        </li>
                                    </ul>
                                </div>
                            </form>
