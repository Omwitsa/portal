...
namespace Unisol.Web.Entities.Migrations
{
    ...
    [Migration("20191030141806_AddFieldToEvaluationTakenByUsers")]
    partial class AddFieldToEvaluationTakenByUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unisol.Web.Entities.Database.MembershipModels.EvaluationQuestionResponseOption", b =>
                {
                    ...
                    b.HasIndex("EvaluationQuestionResponseId");
            ...
            modelBuilder.Entity("Unisol.Web.Entities.Database.MembershipModels.EvaluationQuestionOption", b =>
                {
                    b.HasOne("Unisol.Web.Entities.Database.MembershipModels.EvaluationQuestion")
                        .WithMany("EvaluationQuestionOptions")
            ...
            modelBuilder.Entity("Unisol.Web.Entities.Database.MembershipModels.EvaluationQuestionResponse", b =>
                {
                    b.HasOne("Unisol.Web.Entities.Database.MembershipModels.EvaluationQuestion")
                        .WithMany("EvaluationQuestionResponses")
                        .HasForeignKey("EvaluationQuestionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Unisol.Web.Entities.Database.MembershipModels.EvaluationQuestionResponseOption", b =>
                {
                    b.HasOne("Unisol.Web.Entities.Database.MembershipModels.EvaluationQuestionResponse")
                        .WithMany("EvaluationQuestionResponseOptions")
                        .HasForeignKey("EvaluationQuestionResponseId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
